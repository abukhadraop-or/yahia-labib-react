...
import DesktopModal from 'components/desktop-header-modal/DesktopModal';
...
function DesktopHeader() {
   ...
   *
   * @param {string} list a string to determine which item was hovered over.
   */
  const openMenu = (list) => {
    setShowMenu(true);
    switch (list) {
